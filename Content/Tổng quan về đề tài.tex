...
Chương này tập trung trình bày bối cảnh, lý do hình thành ý tưởng và các thách thức cốt lõi dẫn đến việc phát triển đề tài \textit{“Website học toán tư duy cho học sinh tiểu học”}. Việc xác định rõ mục tiêu chiến lược và phạm vi triển khai sẽ giúp thiết lập một nền tảng cơ sở quan trọng cho các giai đoạn thiết kế và xây dựng hệ thống.
...
\begin{itemize} \item \textbf{Phạm vi chức năng:} Hệ thống tập trung cung cấp kho bài học tương tác, các mini-game rèn luyện phản xạ toán học và hệ thống báo cáo kết quả tự động. Các tính năng về quản lý tài khoản phụ huynh và cơ chế vinh danh thông qua huy hiệu cũng là trọng tâm của giai đoạn phát triển này.
	...
	\item \textbf{Phạm vi người dùng:} Đối tượng phục vụ chính là học sinh thuộc cấp học tiểu học (từ lớp 1 đến lớp 5) cũng như các bậc phụ huynh tại Việt Nam có con em ở lứa tuổi này, đang mong muốn tìm kiếm một nền tảng giáo dục có hỗ trợ Tiếng Việt để đồng hành cùng con trong việc học Toán.
	
	\item \textbf{Phạm vi ngoài đề tài:} Trong giai đoạn này, hệ thống sẽ không hỗ trợ tính năng thi đấu trực tuyến thời gian thực (Real-time Battle) giữa nhiều người chơi cùng lúc, không phát triển ứng dụng di động riêng biệt (Native App) và chỉ tập trung cung cấp nội dung cho cấp học tiểu học.
\end{itemize}