...
\begin{itemize}
	...
	\item Các giao diện liên quan đến học tập: Chủ đề, Đấu trường, Bài kiểm tra, Bài tập tương tác được thể hiện chung trên sơ đồ \textbf{Hình} \ref{fig:system-architecture} qua component Study UI.
