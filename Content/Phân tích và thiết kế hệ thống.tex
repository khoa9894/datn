...
\endfirsthead
\hline
\textbf{Usecase name} & Manage Curriculum (tiếp) \\
\hline
\endhead
\hline
\endfoot
...
\centering
\begin{adjustbox}{max height=0.9\textheight}
\includegraphics[width=\textwidth]{Image/SequenceAdmin.jpg}
\end{adjustbox}
\hspace{2.0cm}
\caption{Sequence diagram Manage Curriculum}
\end{figure}
...
\includegraphics{Image/AcitvityAdmin.jpg}
\end{adjustbox}
\vspace{0.6cm}
\caption{Activity diagram Manage Curriculum}
\end{figure}
