...
\input{Content/KẾ HOẠCH VÀ PHÂN CÔNG CÔNG VIỆC}

\newpage
\subsection{Kế hoạch cho giai đoạn 2}
...
\begin{longtable}{|>{\centering\arraybackslash}m{2cm}|p{7.5cm}|p{4.5cm}|}
	...
	\textbullet\ \textbf{Game:} Nghiên cứu và thiết kế layout khung (Frame) cho phần làm bài tương tác. Đảm bảo tính nhất quán giữa giao diện học tập và giao diện game. & BE: Nguyễn Văn Thành
	...
	\textbullet\ \textbf{Game:} Triển khai các hiệu ứng chuyển cảnh (Transition) giữa các câu hỏi. Thiết kế các hiệu ứng hình ảnh phản hồi khi người dùng chọn đáp án đúng hoặc sai. & BE: Nguyễn Văn Thành
	...
	\textbullet\ \textbf{Game:} Thiết kế các icon huy hiệu (Badges) và hiệu ứng Popup chúc mừng khi người dùng hoàn thành một cột mốc quan trọng trong game. & BE: Nguyễn Văn Thành
	...
	\textbullet\ \textbf{FE:} Phát triển giao diện Ví người dùng hiển thị số dư hiện có. Xây dựng trang lịch sử nhận thưởng chi tiết (thời gian, lý do nhận). 
	
	\textbullet\ \textbf{Game:} Phát triển các hiệu ứng đặc biệt khi nhận thưởng (ví dụ: hiệu ứng mở rương báu, hạt sáng bay vào ví). Tối ưu hóa âm thanh phản hồi khi nhận vật phẩm. & BE: Nguyễn Văn Thành
	...
	\textbullet\ \textbf{Game:} Phát triển logic và giao diện cho các mini-game thi đấu giữa các thành viên gia đình. Đảm bảo tính đồng bộ dữ liệu điểm số trong thời gian thực. & BE: Nguyễn Văn Thành
	...
	\textbullet\ \textbf{FE:} Xây dựng trang "Nhật ký học tập" chi tiết. Cho phép người dùng xem lại các bài tập đã làm sai để ôn tập lại. Cập nhật luồng UX khi người dùng kết thúc một bài giảng. 
	
	\textbullet\ \textbf{Game:} Thiết kế các cột mốc tương tác trong bài giảng (milestones). Tăng cường các yếu tố gamification giúp việc hoàn thành bài tập trở nên thú vị hơn. & BE: Nguyễn Văn Thành
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Image/phase2.png}
	\vspace{0.5cm}
