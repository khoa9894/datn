...
\begin{itemize}
	...
	\item Tìm hiểu và vận dụng các công nghệ: \textbf{Next.js} cho giao diện người dùng, \textbf{Node.js \& Express.js} cho backend API, \textbf{MongoDB} cho cơ sở dữ liệu NoSQL linh hoạt, \textbf{Cocos Creator 3.8} cho các bài tập tương tác và minigame, và \textbf{Colyseus} cho tính năng đa người chơi thời gian thực.
