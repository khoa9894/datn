...
\newpage
Nhóm đã hiện thực được một minigame với tên gọi \textbf{Math Match}. Người chơi sẽ phải nối các phép tính có kết quả bằng nhau để hoàn thành màn chơi.
\begin{figure}[H]
	\centering
...
Khi thêm mới hoặc chỉnh sửa bài tập, hệ thống cung cấp hai phương thức nhập liệu linh hoạt:
\begin{itemize}
