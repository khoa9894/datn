...
Chương này tập trung vào việc mô tả thiết kế giao diện của hệ thống. Giao diện người dùng đóng vai trò quan trọng trong việc mang lại trải nghiệm học tập hiệu quả cho học sinh. Với mục tiêu tạo ra một nền tảng học toán vừa thân thiện vừa hấp dẫn, giao diện người dùng của hệ thống được thiết kế dựa trên các tiêu chí như: dễ sử dụng, trực quan, sáng tạo và phù hợp với lứa tuổi tiểu học. Toàn bộ thiết kế giao diện được thể hiện chi tiết tại: \href{https://www.figma.com/design/SoUfs7Sxqv9unjfvdxj9dB/Dino---DACN?node-id=0-1&t=fxbj1E539k6XP6Ww-1}{Figma - Thiết kế Dino Math}.

\subsection{Trang Landing}
...
\subsection{Trang đăng nhập và đăng ký tài khoản}
...
\newpage
\subsection{Trang Lấy lại mật khẩu}
...
\subsection{Các trang chính của tài khoản Học sinh}
...
\newpage
\subsubsection{Trang Quản lý tài khoản cá nhân}
...
\subsection{Các trang chính của tài khoản Phụ huynh}
...
\subsection{Các trang chính của quản trị viên (Admin)}

\subsubsection{Trang Quản lý tài khoản}
...
\subsubsection{Trang Quản lý học kỳ}
...
\subsubsection{Trang Quản lý khối lớp}
...
\subsubsection{Trang Quản lý bài học}
...
\subsubsection{Trang Quản lý bài tập}
...
\subsubsection{Trang Quản lý bài kiểm tra đầu vào}
...
\subsubsection{Trang Quản lý đấu trường}
...
\subsubsection{Trang Quản lý nhiệm vụ}
...
\subsubsection{Trang Quản lý Minigames}
...
\subsubsection{Trang Quản lý tài chính}
...
Để xây dựng một môi trường học tập toán tư duy hiệu quả, hệ thống bài tập không chỉ dừng lại ở việc kiểm tra kiến thức mà còn phải đóng vai trò là công cụ kích thích sự phát triển trí tuệ. Hệ thống bài tập được thiết kế dựa trên ba trụ cột chính: tính sư phạm, tính tương tác và tính công nghệ.

\subsubsection{Cơ sở thiết kế và chuẩn kiến thức}
Nội dung bài tập được xây dựng dựa trên \textbf{Chương trình Giáo dục phổ thông 2018} của Bộ Giáo dục và Đào tạo Việt Nam \cite{bogddt2018}, tập trung vào 5 mạch kiến thức cốt lõi: Số và phép tính, Hình học và Đo lường, Thống kê và Xác suất. Tuy nhiên, thay vì các bài tập tính toán đơn thuần, đề tài hướng đến việc tích hợp các phương pháp tư duy từ mô hình giáo dục quốc tế như \textbf{Singapore Math (phương pháp CPA: Concrete-Pictorial-Abstract)} \cite{leong2015concrete} để giúp học sinh Việt Nam dễ dàng chuyển đổi từ tư duy trực quan sang tư duy trừu tượng.
...
Để khắc phục nhược điểm nặng về lý thuyết của các hệ thống cũ tại Việt Nam, giải pháp được xây dựng dựa trên việc ứng dụng các nguyên lý trong \textbf{Khung lý thuyết Octalysis} \cite{chou2015} để thiết kế hệ thống phần thưởng và nhiệm vụ:
\begin{itemize}
