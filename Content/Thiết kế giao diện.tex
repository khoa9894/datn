...
\subsubsection{Quản lý chương trình học}
Quản trị viên có thể tạo, chỉnh sửa và xoá nội dung học, tổ chức theo chủ đề và bài học.
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{Image/UI/Admin/Exercise.jpg}
	\vspace{0.6cm}
	\caption{Admin - Quản lý chương trình học}
\end{figure}
